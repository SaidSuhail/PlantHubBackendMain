...
{
    /// <inheritdoc />
    public partial class issuesol : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPlantsAllowed = table.Column<int>(type: "int", nullable: true),
                    MaxPlantsAllowed = table.Column<int>(type: "int", nullable: true),
                    MonthlyReplacements = table.Column<int>(type: "int", nullable: true),
                    WeeklyServices = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingItems_Plants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SwappedFromBookingId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_Bookings_SwappedFromBookingId",
                        column: x => x.SwappedFromBookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_SwappedFromBookingId",
                table: "CartItems",
                column: "SwappedFromBookingId");
